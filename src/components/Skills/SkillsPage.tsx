...
export const SkillsPage = () => {
  ...
  const skills: ReactNode[] = [
    ...
    <AboutMeIcon
      ...
      key="nodeIcon"
    />,
    <AboutMeIcon icon={Icons.DenoIcon} name="Deno" size={100} key="deno" />,
    <AboutMeIcon icon={Icons.BunIcon} name="Bun JS" size={100} key="Bun" />,
    <AboutMeIcon
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center w-fit h-fit drop-shadow-md max-h-[50%] max-w-[50%]">
        <svg
          className={`${
            width < 500 ? "w-[100%] h-[100%]" : "w-72 h-72"
          } fill-primary overflow-visible`}
          viewBox="0 0 16 16"
        ...
        <div
          className={`${width < 500 ? "text-5xl" : "text-6xl"} absolute ${

...
export const HexIcon = ({icon, width, height, name}: Props) => {
    return (
        <div className={`flex justify-center items-center overflow-clip select-none drop-shadow-md w-[${width} px] h-[${height} px] group`}>
            <svg className='w-16 h-16 fill-primary' viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
                <path 
            ...
            <span className='absolute top-10 text-xs text-gray-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300'>{name}</span>
        </div>
    )
};

...
export const CardContent = ({title, bullets, icons, iconsLeft}: Props) => {
    ...
    return (
        <div className="flex flex-col justify-between leading-normal ms-4 text-left ">
            ...
            <div className="mb-3 text-gray-400 ">
                ...
                <div className={`flex flex-row flex-shrink-0 ${iconsLeft ? 'justify-left items-left' : 'justify-center items-center'}`}>

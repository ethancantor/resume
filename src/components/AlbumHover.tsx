...
export default function AlbumHover({link, name, art, date}: Props) {
    ...
    return (
        <div className='bg-raisin-dark rounded-lg p-4 relative'>
            ...
            <div className='transition-opacity ease-in duration-150 opacity-100 hover:opacity-0'>
                <div className='w-[300px] h-[380px] flex flex-col justify-center items-center'>

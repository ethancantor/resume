    ...
    return (
        <div className="fixed h-screen px-3 py-4 bg-raisin flex flex-col items-center top-0 left-0 z-40 w-52 transition-transform -translate-x-full sm:translate-x-0 ">
            ...
            <div className="flex flex-col gap-2 pb-2 items-center text-center">
                ...
                <div className='text-gray-300 text-sm hover:text-primary'>
            ...
            <ul className="space-x-3 font-medium flex flex-row">
                <li>
                    <Link href="https://www.linkedin.com/in/ethan-cantor99/" className="flex items-center p-2 rounded-lg fill-white hover:fill-primary">
                        <svg className='flex-shrink-0 w-5 h-5' xmlns="http://www.w3.org/2000/svg" xmlns-xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24">
                            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                        </svg>
                    </Link>
                </li>
                <li>
                    <Link href="https://github.com/ethancantor" className="flex items-center p-2 rounded-lg fill-white hover:fill-primary">
                        <svg className='flex-shrink-0 w-5 h-5' xmlns="http://www.w3.org/2000/svg" xmlns-xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24">
                ...
                <li>
                    <Link href="/music" className="flex items-center p-2 rounded-lg fill-white hover:fill-primary">
                        <svg className='flex-shrink-0 w-5 h-5' xmlns="http://www.w3.org/2000/svg" xmlns-xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml-space="preserve">

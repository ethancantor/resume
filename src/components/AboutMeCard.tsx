    ...
    return (
        <div className="fixed h-screen px-3 py-4 bg-raisin-dark flex flex-col items-center top-0 left-0 z-40 w-52 transition-transform -translate-x-full sm:translate-x-0 ">
            ...
            <ul className="space-x-3 font-medium flex flex-row">
                <li>
                    <Link href="https://www.linkedin.com/in/ethan-cantor99/" className="flex items-center p-2 rounded-lg fill-white hover:fill-primary transition-all">
                ...
                <li>
                    <Link href="https://github.com/ethancantor" className="flex items-center p-2 rounded-lg fill-white hover:fill-primary transition-all">
                        <svg className='flex-shrink-0 w-5 h-5' xmlns="http://www.w3.org/2000/svg" xmlns-xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24">
                ...
                <li>
                    <Link href="/music" className="flex items-center p-2 rounded-lg fill-white hover:fill-primary transition-all">

...
export const HexIcon = ({icon, width, height, name, onClick, invert}: Props) => {
    ...
    return (
        <div className={`flex justify-center items-center overflow-clip select-none drop-shadow-md group cursor-pointer`} onClick={() => onClick()}>
            ...
            <Image src={icon} alt='icon' width={50} height={50} className={`absolute ${imgSize} flex-shrink ${invert && 'invert'}`}/>
